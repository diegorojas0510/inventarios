      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="vistas/dist/img/diego2-160x160.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Diego Rojas</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
            <!--Imagen del menu izquierdo-->
          <img src="vistas/dist/img/diego2-160x160.jpg" class="img-circle" alt="User Image">
        </div>
